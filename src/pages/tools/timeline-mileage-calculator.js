          ...
          {uploadedFiles.length === 0 && (
            <div className={styles.preCtaPanel}>
              <div className={styles.preCtaContent}>
                ...
                <span>Need ongoing mileage tracking? <a href="/">Dawarich</a> records your trips automatically with full data ownership and privacy. No more manual exports — just continuous, accurate tracking.</span>
              </div>
            </div>
          )}
        ...
        <div className={styles.infoSection}>
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoCard}>
              ...
              <p>To record trips as they happen instead of reconstructing them later, consider using <a href="/">Dawarich</a> — you still add the business purpose yourself.</p>
            </div>
