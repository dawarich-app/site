...
export default function GPXToKML() {
  ...
  const handleConvert = useCallback(async (file) => {
    ...
    try {
      ...
      const kml = toKML(points, { name: file.name.replace(/\.gpx$/i, '') });

      const blob = new Blob([kml], { type: 'application/vnd.google-earth.kml+xml' });
      const url = URL.createObjectURL(blob);
      const a = document.createElement('a');
      a.href = url;
      a.download = file.name.replace(/\.gpx$/i, '.kml');
  ...
  return (
    <Layout title={pageTitle} description={pageDescription}>
      <Head>
        ...
        <meta name="keywords" content="GPX to KML, GPX converter, KML converter, GPS file converter, Google Earth converter, track converter" />
      ...
      <div className={styles.container}>
        <div className={styles.contentWrapper}>
          <div className={styles.header}>
            ...
            <p>Convert your GPX files to KML format instantly. All processing happens in your browser - your data never leaves your device.</p>
          </div>
          <div className={styles.mainContent}>
            <div className={styles.converterSection}>
              <FormatConverter fromFormat="GPX" toFormat="KML" onConvert={handleConvert} isConverting={isConverting} />
              {converted && (
          ...
          <div className={styles.ctaPanel}>
            <div className={styles.ctaContent}>
              ...
              <p>Try Dawarich — a self-hosted location tracking platform with advanced visualization and analysis tools.</p>
              <a href="/?utm_source=converter&utm_medium=cta&utm_campaign=gpx-to-kml" className={styles.ctaButton}>Explore Dawarich</a>
            </div>
          </div>
        </div>
      </div>
