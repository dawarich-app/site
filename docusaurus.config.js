...
const config = {
  ...
  // Optional analytics and advertising tags are loaded after consent by
  // src/utils/consent.js. No Google request is made before an affirmative choice.
  headTags: [
    {
      tagName: "link",
      attributes: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            to: 'https://my.dawarich.app/users/sign_in',
            label: 'Sign in',
            position: 'right',
          },
          {
...
<p class="dawarich-footer-copyright-text">Dawarich® is a registered EU trade mark of ZeitFlow UG (haftungsbeschränkt) · <a href="https://euipo.europa.eu/eSearch/#details/trademarks/019374922" target="_blank" rel="noopener noreferrer">No. 019374922</a></p>`,
      },
      prism: {
