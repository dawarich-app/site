...
The downsides: you need to host it yourself or pay for Cloud (starting at €60/yr for Lite, or €150/yr / €18/mo for the full plan, 7-day free trial). The self-hosted setup requires Docker and a bit of patience. It's not a "download from the App Store and forget" kind of thing.
