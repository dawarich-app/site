...
sidebar_position: 5
title: Kubernetes
description: Install Dawarich on Kubernetes with plain YAML manifests, or with the community Helm chart.
---
...
- Nginx ingress controller with Let's Encrypt integration.
