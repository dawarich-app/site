...
export const PLANS = {
	...
	pro: {
		...
		period: "/year",
		periodMonthly: "/month",
		perMonth: "€15.00/month",
		perDay: "€0.49/day",
		perDayMonthly: "€0.60/day",
		save: "2 months free",
		saveHint: "Get 2 months for free",
		badge: "MOST POPULAR",
	...
	family: {
		...
		valueStack: {
			items: [
				...
				{ label: "4 additional Pro seats", value: 720 },
				{ label: "Real-time family location sharing", value: 40 },
				{ label: "White-Glove Import Service", value: 99, bonus: true },
			],
			total: "1,039",
			payLine: "Yours for €299.99/yr",
		},
