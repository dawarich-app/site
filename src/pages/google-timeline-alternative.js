...
export default function GoogleTimelineAlternativePage() {
	...
	return (
		<Layout
			...
			description="Google killed Timeline and moved your data on-device only. Dawarich Cloud imports your Google Takeout in minutes, gives you back heatmaps and trip detection, and stores it all privately in Germany. From €149.99/year. 7-day free trial."
		>
			<Head>
